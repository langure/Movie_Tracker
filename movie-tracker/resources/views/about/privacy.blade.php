        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h1 class="text-4xl font-bold text-white">Interpretation and Definitions</h1>
                    <h2 class="text-2xl font-bold text-gray-800">Interpretation</h2>
                    <p>The words of which the initial letter is capitalized have meanings defined under the following
                        conditions. The following definitions shall have the same meaning regardless of whether they
                        appear in singular or in plural.</p>
                    <h2 class="text-2xl font-bold text-gray-800">Definitions</h2>
                    <p>For the purposes of this Privacy Policy:</p>
                    <ul>
                        <li class="list-disc ml-4 text-white-800">
                        ...
                        <li class="list-disc ml-4 text-white-800">
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Movie Tracker.</p>
                        </li>
                        <li class="list-disc ml-4 text-white-800">
                        ...
                        <li class="list-disc ml-4 text-white-800">
                            <p><strong>Website</strong> refers to Movie Tracker, accessible from <a
                                    href="https://movie-tracker.com" rel="external nofollow noopener"
                                    target="_blank">https://movie-tracker.com</a></p>
                        </li>
                        <li class="list-disc ml-4 text-white-800">
                    ...
                    <h1 class="text-4xl font-bold text-white">Collecting and Using Your Personal Data</h1>
                    <h2 class="text-2xl font-bold text-gray-800">Types of Data Collected</h2>
                    <h3>Personal Data</h3>
                    ...
                    <ul>
                        <li class="list-disc ml-4 text-white-800"><strong>Cookies or Browser Cookies.</strong> A cookie
                        ...
                        <li class="list-disc ml-4 text-white-800"><strong>Web Beacons.</strong> Certain sections of our
                            Service and our emails may contain
                    ...
                    <h2 class="text-2xl font-bold text-gray-800">Use of Your Personal Data</h2>
                    ...
                    <ul>
                        <li class="list-disc ml-4 text-white-800"><strong>With Service Providers:</strong> We may share
                            Your personal information with Service
                            Providers to monitor and analyze the use of our Service, to contact You.</li>
                        <li class="list-disc ml-4 text-white-800"><strong>For business transfers:</strong> We may share
                        ...
                        <li class="list-disc ml-4 text-white-800"><strong>With Affiliates:</strong> We may share Your
                            information with Our affiliates, in
                        ...
                        <li class="list-disc ml-4 text-white-800"><strong>With business partners:</strong> We may share
                            Your information with Our business
                            partners to offer You certain products, services or promotions.</li>
                        <li class="list-disc ml-4 text-white-800"><strong>With other users:</strong> when You share
                        ...
                        <li class="list-disc ml-4 text-white-800"><strong>With Your consent</strong>: We may disclose
                            Your personal information for any other
                            purpose with Your consent.</li>
                    </ul>
                    <h2 class="text-2xl font-bold text-gray-800">Retention of Your Personal Data</h2>
                    ...
                    <h2 class="text-2xl font-bold text-gray-800">Transfer of Your Personal Data</h2>
                    ...
                    <h2 class="text-2xl font-bold text-gray-800">Delete Your Personal Data</h2>
                    ...
                    <h2 class="text-2xl font-bold text-gray-800">Disclosure of Your Personal Data</h2>
                    ...
                    <p>The Company may disclose Your Personal Data in the good faith belief that such action is
                        necessary to:</p>
                    <ul>
                        <li class="list-disc ml-4 text-white-800">Comply with a legal obligation</li>
                        <li class="list-disc ml-4 text-white-800">Protect and defend the rights or property of the
                            Company</li>
                        <li class="list-disc ml-4 text-white-800">Prevent or investigate possible wrongdoing in
                            connection with the Service</li>
                        <li class="list-disc ml-4 text-white-800">Protect the personal safety of Users of the Service or
                            the public</li>
                        <li class="list-disc ml-4 text-white-800">Protect against legal liability</li>
                    </ul>
                    <h2 class="text-2xl font-bold text-gray-800">Security of Your Personal Data</h2>
                    <p>The security of Your Personal Data is important to Us, but remember that no method of
                        ...
                        absolute security.</p>
                    <h1 class="text-4xl font-bold text-white">Children's Privacy</h1>
                    ...
                    <p>If We need to rely on consent as a legal basis for processing Your information and Your country
                        ...
                        that information.</p>
                    <h1 class="text-4xl font-bold text-white">Links to Other Websites</h1>
                    ...
                    <h1 class="text-4xl font-bold text-white">Changes to this Privacy Policy</h1>
                    ...
                    <ul>
                        <li class="list-disc ml-4 text-white-800">By email: admin@movie-tracker.com</li>
                    </ul>
                </div>
            </div>
        </div>
